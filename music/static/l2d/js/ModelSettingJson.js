...
{    
    ...
    pm.loadBytes(path, function(buf) {
        var str = this.Utf8ArrayToStr(new Uint8Array(buf)) ;
...
//获取文字
ModelSettingJson.prototype.getMotionTip = function(name, n)
{
    if (this.json[this.MOTION_GROUPS] == null || 
        this.json[this.MOTION_GROUPS][name] == null || 
        this.json[this.MOTION_GROUPS][name][n] == null || 
        this.json[this.MOTION_GROUPS][name][n][this.TIP] == null)
        return null;
    return this.json[this.MOTION_GROUPS][name][n][this.TIP];
}
